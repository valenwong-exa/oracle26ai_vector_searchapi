...
logger = logging.getLogger("oracle_vector_api_bge")
...
if __name__ == "__main__":
    uvicorn.run("oracle_vector_api_bge:app", host=DEFAULT_API_HOST, port=DEFAULT_API_PORT, reload=False)
